    ...
    <div class="flex font-bold text-gray-400 border-t border-gray-300 bg-white">
      <div class="flex-1">
        <div class="flex items-center text-xs leading-9 font-medium font-mono">
          ...
          <div data-testid="version-line" class="flex items-center transition-colors duration-700 ease-in-out">
            <svg
      ...
      <div class="flex items-center ml-3 px-2.5 space-x-1 border-l border-gray-300 transition-colors duration-700">
        <a href="https://alpinejs.dev" target="_blank" title="Alpine.js Docs" class="hover:opacity-75">
        ...
        <a
          href="https://github.com/sponsors/HugoDF"
          target="_blank"
        ...
        {settingsPanelEnabled() && (
          <button class="hover:opacity-75 focus:outline-none" onClick={() => setSettingsPanelOpen(true)}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
